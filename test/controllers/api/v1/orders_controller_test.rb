...
class Api::V1::OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should show order' do
    ...
    assert_not_equal @order.products.first.title, include_product_attr
  end
  ...
  test 'should create order with two products' do
    assert_difference('Order.count', 1) do
      post api_v1_orders_url, headers: { Authorization: JsonWebToken.encode(user_id: @order.user_id) },
                              params: @order_params,
                              as: :json
    end
